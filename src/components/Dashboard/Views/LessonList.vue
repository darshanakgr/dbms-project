...
<script>
  ...
  const tableColumnNames = ['Lesson ID', 'Lesson Name', 'Options'] /* Give here the names of the attributes */
  const tableColumns = ['lesson_id', 'lesson_name', 'options']  /* Give here the column names as they are in the table */
  ...
  export default {
    ...
    data () {
      return {
        table1: {
          title: 'Lessons',
          subTitle: 'All the course modules available in this school are listed below.',
