...
<script>
  import PaperTable from './Category/PaperTable.vue'
  const tableColumnNames = ['Category ID', 'Instrument Type', 'Options'] /* Give here the names of the attributes */
  const tableColumns = ['category_id', 'instrument_type', 'options']  /* Give here the column names as they are in the table */
  ...
  export default {
    ...
    data () {
      return {
        table1: {
          title: 'Categories',
          subTitle: 'All the instrument categories are listed below.',
