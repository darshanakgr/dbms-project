        ...
        <div class="modal-container" @click.stop>
          <div class="modal-header">
            ...
            <div class="modal-body">
              ...
              <label class="form-label">
                Address Line 1
                <input v-model="dataObject.address1" class="form-control" name="address1" v-validate="'required|alpha'">
                <span v-show="errors.has('address1')" style="color:red">Address is required</span>
              </label>
              <label class="form-label">
                Address Line 2
                <input v-model="dataObject.address2" class="form-control" name="address2" v-validate="'required|alpha'">
