...
<script>
  ...
  const tableColumnNames = ['Instrument ID', 'Instrument Name', 'Purchase Date', 'Instrument Category', 'Options'] /* Give here the names of the attributes */
  const tableColumns = ['instrument_id', 'instrument_name', 'purchased_date', 'category_id', 'options']  /* Give here the column names as they are in the table */
